      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 max-h-[90vh] w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-2xl border border-white/[0.1] bg-bg-secondary p-6 shadow-elevated focus:outline-none">
          <div className="mb-5 flex items-start justify-between gap-4">
            <div>
              <Dialog.Title className="text-lg font-bold text-text">Create Task</Dialog.Title>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              <label htmlFor="task-description" className="mb-2 block text-sm font-medium text-text-secondary">
                Description
              </label>
              <textarea
                id="task-description"
            ...
            <div>
              <label htmlFor="task-due-date" className="mb-2 block text-sm font-medium text-text-secondary">
                Due date
              </label>
              <input
                id="task-due-date"
            ...
            <input type="hidden" {...register('estimatedEffort')} />
